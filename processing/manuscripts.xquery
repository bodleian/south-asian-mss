...
declare variable $countryauthorities := doc('../authority/authority/places.xml')/tei:TEI/tei:text/tei:body//tei:listPlace/tei:place[@xml:id and @type='country'];
declare variable $worksauthority := doc("../authority/authority/works.xml");
